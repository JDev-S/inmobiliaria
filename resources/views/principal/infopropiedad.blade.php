        ...
        <div class="parallax-content">
            <div class="container section-top-34 section-md-top-98 section-bottom-34">
                ...
                <ul class="list-inline list-inline-dashed p text-light breadcrumb-modern offset-top-10 offset-md-top-66">
                    ...
                    <li class="list-inline-item"><a href="catalog.html">Catalog</a></li>
...
<section class="section-98 section-md-110 novi-background bg-cover bg-default">
    <div class="container">
        ...
        <div class="offset-md-top-66">
            <div class="row row-fix">
                <div class="col-lg-7 col-xl-8">
                    <!-- Owl Carousel-->
                    <div class="owl-carousel owl-carousel-classic" data-items="1" data-dots="true" data-nav="true" data-nav-class="[&quot;owl-prev mdi mdi-chevron-left&quot;, &quot;owl-next mdi mdi-chevron-right&quot;]"><a class="thumbnail-classic" data-lightgallery="item" href="images/single-property-page-01-770x510.jpg">
                            <figure><img src="images/single-property-page-01-770x510.jpg" alt="" />
                            </figure>
                        </a><a class="thumbnail-classic" data-lightgallery="item" href="/images/single-property-page-02-770x510.jpg">
                            <figure><img src="images/single-property-page-02-770x510.jpg" alt="" />
                            </figure>
                        </a><a class="thumbnail-classic" data-lightgallery="item" href="/images/single-property-page-03-770x510.jpg">
                            <figure><img src="images/single-property-page-03-770x510.jpg" alt="" />
                            </figure>
                        </a><a class="thumbnail-classic" data-lightgallery="item" href="/images/single-property-page-05-770x510.jpg">
                            <figure><img src="images/single-property-page-05-770x510.jpg" alt="" />
                            </figure>
                        </a><a class="thumbnail-classic" data-lightgallery="item" href="/images/single-property-page-06-770x510.jpg">
                            <figure><img src="images/single-property-page-06-770x510.jpg" alt="" />
                            </figure>
                        </a><a class="thumbnail-classic" data-lightgallery="item" href="/images/single-property-page-07-770x510.jpg">
                            <figure><img src="images/single-property-page-07-770x510.jpg" alt="" />
                            </figure>
                        </a><a class="thumbnail-classic" data-lightgallery="item" href="/images/single-property-page-08-770x510.jpg">
                            <figure><img src="images/single-property-page-08-770x510.jpg" alt="" />
                            </figure>
                        </a>
                    </div>
                    ...
                    <div class="row row-fix">
                        <div class="col-sm-12 offset-top-50 order-lg-4">
                            <div class="unit unit-md flex-lg-row">
                                <div class="unit-left"><img class="img-fluid d-inline-block" src="/images/user-shirley-vasquez-120x120.jpg" width="120" height="120" alt=""></div>
                                <div class="unit-body">
                                    <div>
                                    ...
                                    <div class="offset-top-10">
                                        <address class="contact-info text-lg-left">
                                            <ul class="list-unstyled p">
                                                ...
                                                <li class="d-block"><span class="novi-icon icon icon-xxs mdi mdi-email-open text-middle"></span> <a class="d-inline-block text-middle" href="mailto:russell@demolink.org">shirley@demolink.org</a>
                                                </li>
                                            </ul>
                                        </address>
                                    </div>
                        ...
                        <div class="col-sm-12 order-lg-2 offset-top-41 offset-lg-top-20"><a class="btn btn-primary" href="#">contact an agent</a>
            ...
            <div class="row row-60 justify-content-sm-center">
                <div class="col-md-4"><img class="img-fluid d-inline-block" src="images/home-img-11-370x250.jpg" width="370" height="250" alt="">
                    <div class="text-md-left offset-top-24">
                        <div>
                            <h5 class="font-weight-bold text-primary"><a href="/info_propiedad">Scandia Vista Apartments</a></h5>
                        </div>
                ...
                <div class="col-md-4"><img class="img-fluid d-inline-block" src="images/home-img-08-370x250.jpg" width="370" height="250" alt="">
                    <div class="text-md-left offset-top-24">
                        <div>
                            <h5 class="font-weight-bold text-primary"><a href="/info_propiedad">Alchemy by Alta</a></h5>
                        </div>
                        <h6 class="offset-top-10"> $1199.00/mon</h6>
                        <ul class="list-inline list-inline-dotted text-dark">
                            <li class="list-inline-item">1200 sq ft</li>
                ...
                <div class="col-md-4"><img class="img-fluid d-inline-block" src="images/home-img-09-370x250.jpg" width="370" height="250" alt="">
                    <div class="text-md-left offset-top-24">
                        <div>
                            <h5 class="font-weight-bold text-primary"><a href="/info_propiedad">Avalon at Mission Bay</a></h5>
                        </div>
